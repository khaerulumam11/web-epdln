    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3" id="tables">
        <div class="card-header" >
          ...
          <?php
          $id = $_GET['id'];
          $results = mysqli_query($config, "SELECT perjadin.id as id ,delegasi.jenispeserta,delegasi.estimasi, delegasi.komponenbiaya, delegasi.waktuawal, delegasi.waktuakhir, delegasi.id as id_delegasi, pegawai.id_pegawai, pegawai.nama_pegawai, pegawai.nik, pegawai.nip, pegawai.jabatan, pegawai.email, pegawai.instansi, pegawai.nohp from delegasi  join perjadin on perjadin.id = delegasi.id_perjadin join pegawai on delegasi.id_pegawai = pegawai.id_pegawai where perjadin.id = '$id' ");
        ...
        <div class="">
          <div class="">
            ...
            <tr>
            <td style="width:25%"><b>Nama Delegasi</b></td>
              <td style="width:1%">:</td>
              <td><?php echo $row['nama_pegawai'] ?></td>
            </tr>
            <tr>
            <td style="width:15%"><b>NIP Delegasi</b></td>
              <td style="width:1%">:</td>
              <td><?php echo $row['nip'] ?></td>
            </tr>
            <tr>
            <td style="width:15%"><b>NIK Delegasi</b></td>
              <td style="width:1%">:</td>
            ...
            <tr>
            <td style="width:15%"><b>Nomor HP</b></td>
              <td style="width:1%">:</td>
            ...
            <tr>
            <td style="width:15%"><b>Estimasi Biaya</b></td>
              <td style="width:1%">:</td>
              <td> Rp.<?php echo $row['estimasi'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
            <td style="width:15%"><b>Instansi</b></td>
              <td style="width:1%">:</td>
              <td><?php echo $row['instansi'] ?> </td>
            </tr>
            <tr>
            <td style="width:15%"><b>Jenis Peserta</b></td>
              <td style="width:1%">:</td>
              <td><?php echo $row['jenispeserta'] ?> </td>
            </tr>
            <tr>
            <td style="width:15%"><b>Waktu Penugasan Awal</b></td>
              <td style="width:1%">:</td>
              <td><?php echo $row['waktuawal'] ?></td>
            </tr>
            <tr>
            <td style="width:15%"><b>Waktu Penugasan Akhir</b></td>
              <td style="width:1%">:</td>
              <td><?php echo $row['waktuakhir'] ?></td>
            </tr>
            </table>
          </div>
        </div>
