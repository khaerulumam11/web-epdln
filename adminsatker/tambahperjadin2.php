    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3" id="">
        <div class="card-header" >
          <i class="fa"></i> Formulir Perjalanan Dinas
        </div>
        <?php
        $id = $_GET['id'];
        ...
        <div class="card-body">
          <div class="table-responsive">
            <form action="../proses/tambahperjadin_process2.php?id=<?php echo $row['id'];?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <td style="height:100%">
                  ...
                  $jsArray = "var prdName = new Array();\n";
                    ...
                    echo '<select style="width:100%;height:40px" class="form-control" name="" onchange="document.getElementById(\'id\').value = prdName[this.value]">';
                    echo '<option disabled selected>--Pilih Kegiatan--</option>';

                  while ($row = mysqli_fetch_array($results)){

                  echo '<option value="'. $row['namakegiatan'].'">'. $row['namakegiatan'] . '</option>';
                  $jsArray .= "prdName['" . $row['namakegiatan'] . "'] = '" . addslashes($row['id']) . "';\n";
                  } ?>
                </select>
               </td>
             </tr>
             <tr>
               ...
               <td>
               <input style="width:100%;height:40px" class="form-control" type="hidden" name="id" id="id" readonly></input>
            ...
            <tr>
              <td style="padding:10px; width:20%">
          <b><label required>No Pengajuan Satuan Kerja : </label></b></td>
          <td style="height:100%">
