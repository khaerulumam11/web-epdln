    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <center>
          <a class="nav-link" href="dashboard_adminspuski.php">
    ...
    <div class="container-fluid">
      ...
      <div class="card-header" >
        ...
        <div class="card mb-3" id="tables" style="width:100%; margin-top:3%">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form action="../proses/tambahkegiatan_process.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <td style="height:100%">
                    <input style="width:80%;height:40px" class="form-control" type="text" name="nama" placeholder="Nama Kegiatan"></input>
                </td>
              </tr>
              </div>
                <div class="form-group">
                  ...
                  <td>
                  <input style="width:80%;height:40px" class="form-control" type="text" name="ke" placeholder="Pertemuan Ke"  ></input>
                 </td>
              </tr>
            </div>
            <div class="form-group">
              ...
              <td>
              <textarea style="width:80%;height:60px" class="form-control" type="text" name="deskripsi" placeholder="Deskripsi Kegiatan" ></textarea>
             </td>
          </tr>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <td>
          <input style="width:80%;height:40px" class="form-control" type="text" name="bobot" id="bobot" placeholder="Bobot Prioritas" readonly></input>
          <script type="text/javascript">
          <?php echo $jsArray; ?>
          </script>
         </td>
          ...
          <tr >
              <td style="padding:10px">
                  <b><label for="exampleInputPassword1">Tanggal Mulai </label> </b> </td>
                    <td>
                        <input style="width:80%;height:40px"  type="text" name="tglmulai" id="datepicker" placeholder=" Tanggal Mulai" />
                          </td>
                        </tr>
          </div>
          <div class="form-group">
                <tr >
                    <td style="padding:10px">
                        <b><label for="exampleInputPassword1">Tanggal Akhir </label> </b> </td>
                          <td>
                              <input style="width:80%;height:40px"  type="text" name="tglakhir" id="datepicker1" placeholder=" Tanggal Akhir"/>
                                </td>
                              </tr>
                </div>
          <div class="form-group">
                        ...
                        <b><label for="exampleInputPassword1">Satuan Kerja </label> </b> </td>
                          <td>
                              <select placeholeder="Satuan Kerja" style="width:80%;height:40px" class="select2 form-control" name="satker[]" id="" multiple >
                                ...
                                while ($row = mysqli_fetch_array($results)){
                                ?>
                                <option><?php echo $row['satker'] ?></option>
                                  <?php } ?>
                                </select>
                                </td>
                              </tr>
                    ...
                    <tr >
                        <td style="padding:10px">
                              ...
                              <td>
                                ...
                                <input style="width:80%;height:40px" class="form-control"  type="text" name="kota" placeholder="Nama Kota"/>
                          ...
                          <tr >
                              <td style="padding:10px">
                                  <b><label for="exampleInputPassword1">Kompetensi </label> </b> </td>
                                    <td>
                                        <input style="width:80%;height:40px" class="form-control" type="text" name="kompetensi" id="datepicker1" placeholder="Kompetensi (Contoh : Hukum, Cybercrime, dll)" />
                                          </td>
                                        </tr>
                          </div>
                                              ...
                                              <b><label for="exampleInputPassword1">Komponen Biaya</label> </b> </td>
                                                <td>
                                                  <select style="width:80%;height:40px" class="form-control" name="biaya">
                                                    ...
                                                    <option disabled selected>--Pilih Komponen Biaya--</option>
                                                    <option>APBN</option>
                                                    <option>Donor</option>
                                            ...
                                            <tr >
                                                <td style="padding:10px">
                                                    <b><label for="exampleInputPassword1">Deadline </label> </b> </td>
                                                      <td>
                                                          <input style="width:80%;height:40px"  type="text" name="deadline" id="deadline" placeholder=" Deadline"/>
                                                            </td>
                                                          </tr>
                                            </div>
                                            <div class="form-group">
                                                  <tr >
                                                      <td style="padding:10px">
                                                          <b><label for="exampleInputPassword1">Jumlah Delegasi </label> </b> </td>
                                                            <td>
                                                                <input style="width:80%;height:40px" class="form-control" type="number" name="jmldelegasi" placeholder="Jumlah Delegasi (Minimal 1 orang)" />
                                                                  </td>
                                                                </tr>
                                                  </div>
